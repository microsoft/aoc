"""
Example: Train an AOC DEQ model on MNIST classification.

This script demonstrates how to train a Deep Equilibrium (DEQ) model
using the AOC digital twin on the MNIST handwritten digit classification task.

Usage:
    python examples/train_mnist.py --epochs 20 --lr 3e-4
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train AOC model on MNIST")
...
def main():
    ...
    # Create model
    # MNIST: 28x28 = 784 input features, 10 output classes
    d_in = 784
